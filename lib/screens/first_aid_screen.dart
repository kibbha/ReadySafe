...
class _FirstAidScreenState extends State<FirstAidScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final guides = firstAidGuides.where((g) {
      ...
      return t.get(g.titleKey).toLowerCase().contains(q) ||
          t.get(g.summaryKey).toLowerCase().contains(q);
    }).toList();
        ...
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Text(t.get('medicalNotice'), style: const TextStyle(fontWeight: FontWeight.w700))),
            ]),
          ),
          const SizedBox(height: 12),
          if (guides.isEmpty)
          ...
          ...guides.map((g) => _GuideCard(
                guide: g,
                title: t.get(g.titleKey),
                summary: t.get(g.summaryKey),
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => FirstAidDetailScreen(guide: g)),
                ),
              )),
        ],
      ),
          ...
          child: Row(children: [
            Container(
              ...
              child: illustration == null
                  ? const Icon(Icons.health_and_safety_outlined, color: Color(0xff087f83))
                  : SvgPicture.asset(illustration, fit: BoxFit.contain),
            ),
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(summary, maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(height: 1.25, color: Color(0xff65747a))),
              ]),
            ),
        ...
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 10),
              Expanded(child: Text(t.get('aid_call_now'), style: const TextStyle(fontWeight: FontWeight.w800))),
              FilledButton(
                style: FilledButton.styleFrom(backgroundColor: Theme.of(context).colorScheme.error, minimumSize: const Size(72, 40)),
          ...
          const SizedBox(height: 14),
          ...guide.steps.indexed.map((e) => _StepCard(number: e.$1 + 1, step: e.$2)),
          const SizedBox(height: 6),
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Icon(Icons.verified_outlined, size: 18, color: Color(0xff087f83)),
            const SizedBox(width: 7),
            Expanded(child: Text(t.get('medicalNotice'), style: const TextStyle(fontSize: 12, color: Color(0xff65747a)))),
          ]),
        ],
      ),
    );
      ...
      child: Padding(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          SizedBox(
            ...
            child: Column(children: [
              Row(children: [
                ...
                const SizedBox(width: 7),
                Expanded(child: Text(t.get('step', {'number': '$number'}), maxLines: 1, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w900))),
              ]),
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xfff2f8f8), borderRadius: BorderRadius.circular(13)),
                child: Semantics(
                  image: true,
          ...
          Expanded(child: Padding(
            ...
            child: Text(_aidText(context, step.textKey), style: const TextStyle(fontSize: 15, height: 1.4, fontWeight: FontWeight.w600)),
          )),
        ]),
      ),
    );
