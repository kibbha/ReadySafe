...
class _GlobalSearchScreenState extends State<GlobalSearchScreen> {
  ...
  List<_SearchHit> _hits(String query) {
    ...
    const shortcuts = <String, _SearchHit>{
      ...
      'voyage': _SearchHit('Voyage', 'Urgence en voyage', Icons.luggage_rounded, TravelEmergencyScreen()),
      'passeport perdu': _SearchHit('Voyage', 'Urgence en voyage', Icons.luggage_rounded, TravelEmergencyScreen()),
      'consulat': _SearchHit('Voyage', 'Urgence en voyage', Icons.account_balance_outlined, TravelEmergencyScreen()),
      'ambassade': _SearchHit('Voyage', 'Urgence en voyage', Icons.account_balance_outlined, TravelEmergencyScreen()),
