...
final firstAidGuides = [
  ...
  _guide(
    'bleeding',
    'aid_bleeding',
    'aid_bleeding_summary',
    ['aid_bleeding_1', 'aid_bleeding_2', 'aid_bleeding_3'],
    sources: [_erc2025, _ercFirstAid2025],
    illustrations: [
      'assets/illustrations/bleeding_pressure.svg',
      'assets/illustrations/bleeding_dressing.svg',
      'assets/illustrations/bleeding_tourniquet.svg',
    ],
  ),
