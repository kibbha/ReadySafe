...
// ReadySafe keeps the guidance text offline, while retaining authoritative
// references so the medical content can be reviewed/versioned. Illustrations
// remain original ReadySafe assets; ERC artwork is not bundled.
